...
r.avaflow -t prefix=ca_exp4 cellsize=20 phases=m layers=2 controls=0,0,1,2,0,0,0,0,0,2,0 elevation=ca_elev hrelease1=ca_landslide hrelease3=ca_lake4 density=2800,1000,1000 friction=1,22,0,0,1,0,0.05 viscosity=0,2,0,0,0,1 time=5,150 visualization=1.0,5.0,5.0,1,1000,20,0,3000,50,0.50,0.50,0.50,0.2,1.0,None,None,None
...
r.avaflow prefix=ca_exp5 cellsize=20 phases=m controls=0,0,1,2,1,0,0,0,0,2,0 elevation=ca_elev1 hrelease1=ca_hrelease1 hrelease2=ca_hrelease2 hrelease3=ca_hrelease3 trelease=ca_trelease trelstop=ca_trelstop hentrmax1=ca_moraine basal=-6.25,0 density=2800,1000,1000 friction=35,22,0,0,0,0,0.05 viscosity=-9999,0.0,1.5,0.0,-3.0,0.0 time=5,600 thresholds=1.0,10000,10000,0.000001 ortho=DATA/ca_ortho.tif hydrocoords=6765,4065,300,75,4870,2145,1000,130 hydrograph=DATA/ca_hydrograph5.txt visualization=1.0,5.0,5.0,1,1000,25,0,3000,50,0.60,0.60,0.10,0.2,1.0,None,None,None

#Experiment #6 - Rock glacier
r.avaflow prefix=ca_exp6 cellsize=20 aoicoords=4400,1800,3500,5500 phases=f controls=0,0,0,0,0,0,0,0,0,2,0 elevation=ca_elev1 hrelease=ca_debrisflow density=2800 viscosity=0,0 time=2,200 thresholds=1.0,10000,10000,0.000001 slomo=315360000 ortho=DATA/ca_ortho.tif frictiograph=DATA/ca_frictiograph.txt visualization=1.0,5.0,5.0,5,200,5,0,3000,50,0.50,0.80,0.10,0.2,1.0,None,None,None

#Experiment #7 - Deep-seated gravitational slope deformation
r.mapcalc --overwrite "ca_surf1 = min(450+(x()-30)*0.24+(y()-1550)*0.58,ca_elev1)"
r.mapcalc --overwrite "ca_surf2 = min(550+(x()-30)*0.24+(y()-1550)*0.58,ca_elev1)"
r.mapcalc --overwrite "ca_surf3 = min(650+(x()-30)*0.24+(y()-1550)*0.58,ca_elev1)"
...
r.avaflow prefix=ca_exp7 cellsize=20 phases=s,s,s layers=2 controls=0,0,0,0,0,0,0,0,0,2,0 elevation=ca_elev7 hrelease1=ca_hrelease1 hrelease2=ca_hrelease2 hrelease3=ca_hrelease3 density=2800,2800,2800 viscosity=20,50000000000,20,30000000000,20,20000000000 time=5,200 thresholds=1.0,10000,10000,0.000001 slomo=31536000000 ortho=DATA/ca_ortho.tif visualization=5.0,5.0,5.0,5,1000,5,0,3000,50,0.5,0.5,0.5,0.2,1.0,None,None,None cfl=0.5,0.1 profile=2500,3000,100,100 tslide=ca_tslide slidepar=0,0,1
